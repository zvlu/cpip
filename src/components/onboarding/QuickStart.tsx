...
export function QuickStart({ steps, onDismiss }: QuickStartProps) {
  ...
  if (collapsed) {
    return (
      <button
        ...
        className="fixed bottom-6 right-6 px-4 py-3 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition-colors shadow-lg flex items-center gap-2 z-40"
      >
        <span>📚</span>
  ...
  return (
    <div className="fixed bottom-6 right-6 w-96 bg-white rounded-lg border border-gray-200 shadow-lg z-40 animate-slide-up">
      {/* Header */}
